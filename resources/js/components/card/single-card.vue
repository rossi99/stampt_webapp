                        ...
                        <div class="card-details-container">
                            ...
                            <div class="card-preview-container">
                                <div class="card-preview-content alignMiddle">
                                    <!-- Show if 5 stamps -->
                                    <div v-if="card.stampSlots === 5" class="one-row-card" :style="{ background: `${card.backgroundColour}` }">
                                        ...
                                        <div class="stamp-logo-holder">
                                            ...
                                            <div class="preview-txt-container" :style="{ color: `${card.fontColour}` }">
                                            ...
                                            <!-- Stamp Rows -->
                                            <!-- Will check how many stamps, 5 = 1 row: -->
                                    ...
                                    <!-- Show if 10 stamps -->
                                    <div v-if="card.stampSlots === 10" class="two-row-card" :style="{ background: `${card.backgroundColour}` }">
                                        <!-- logo and stamp container -->
                                        <div class="stamp-logo-holder">
...
export default {
    ...
    created() {
        ...
        // Get single card
        axios.get(`/api/loyaltyCards/${id}`).then(response => {
